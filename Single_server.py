...
# Variables to store the last and next event times
...
def report():
    ...
    if sim_time > 0:
        print("Average number in queue{:10.3f}".format(
            area_num_in_q / sim_time))
        print("Server utilization{:15.3f}".format(
...
def update_time_avg_stats():
    # Add global declaration for time_last_event
