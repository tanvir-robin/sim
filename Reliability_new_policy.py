...
print("Time spent in bearing replacement =", total_change *
      three_bearing_change_time_minutes, "minutes")
print("Total downtime =", total_delay_minutes +
      (total_change*three_bearing_change_time_minutes), "minutes")

cost_of_downtime = cost_of_downtime_per_minutes * \
    (total_delay_minutes+(total_change*three_bearing_change_time_minutes))
print("Cost of downtime = Rs.",  cost_of_downtime)
cost_of_repairman = total_change * \
    three_bearing_change_time_minutes*cost_of_repairman_per_hour/60
