...
print(
    f"Probability that the selected parts will not assemble: {not_assemble_prob} or {not_assemble_prob*100} %")
print(
    f"Probability that the selected parts will assemble: {assemble_prob} or {assemble_prob*100} %")
